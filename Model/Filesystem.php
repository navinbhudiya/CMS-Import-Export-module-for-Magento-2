...
namespace Navin\CmsImportExport\Model;
...
class Filesystem
{
    const EXPORT_PATH = 'navin_cmsimportexport/export';
    const EXTRACT_PATH = 'navin_cmsimportexport/extract';
    const UPLOAD_PATH = 'navin_cmsimportexport/extract';
